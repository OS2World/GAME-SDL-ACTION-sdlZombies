/*
 * src/errno.h — local shadow of the system errno.h for OS/2 GCC 9.
 *
 ...
 *
 * Solution: intercept all <errno.h> includes via "-I src" (which is searched
 * before system directories).  This file has proper include guards and uses
 * "#ifndef errno" to skip the _errno declaration when the macro is already
 * active, preventing the type conflict.
 */

#ifndef _SDLZ_ERRNO_H_
#define _SDLZ_ERRNO_H_
